...
import "./Sidebar.css";
import profileImage from "../images/Karan_Manickam.jpeg";
  ...
  return (
    <aside className="sidebar">
      <div className="sidebar-card">
        ...
        <h1 className="profile-name">Karan Manickam</h1>
        ...
        {/* <div className="profile-icon">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="var(--accent-orange)" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12 21A9 9 0 1 0 12 3A9 9 0 0 0 12 21Z" stroke="var(--accent-orange)" strokeWidth="2"/>
            <path d="M12 18V13M12 8H12.01" stroke="var(--accent-orange)" strokeWidth="2" strokeLinecap="round"/>
          </svg>
        </div> */}

        <p className="profile-bio">
          I build efficient, user-centric web solutions that turn ideas into
        ...
        <div className="social-links">
          ...
          {/* <a href="#" className="social-icon" aria-label="Portfolio">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
